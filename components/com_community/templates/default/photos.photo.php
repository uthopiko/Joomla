						...
						{id: <?php echo $photo->id; ?>,
						 ...
						 tags: [
							<?php foreach($photo->tagged as $tagItem){ ?>
							{
                                ...
                                displayName: '<?php echo $tagItem->userid != 0 ? addslashes($tagItem->user->getDisplayName()) : $tagItem->text; ?>',
								profileUrl: '<?php echo $tagItem->userid != 0 ? CRoute::_('index.php?option=com_community&view=profile&userid='.$tagItem->userid, false): JRoute::_('../index.php')?>',
