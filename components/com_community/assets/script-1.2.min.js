...
}else{jax.call("community","photos,ajaxUploadAvatar",c,d);}}break;case"group":g=joms.jQuery(".cPageAvatar img").prop("src");joms.jQuery(".cPageAvatar img").prop("src",a);
...
});function update_counter(a,c){if(!c){c=0;}var b=parseInt(joms.jQuery(a).html(),10);c=parseInt(c,10);if(b<=1){joms.jQuery(a).css("display","none");}else{joms.jQuery(a).html(b+c);
...
joms.maps.init();joms.like.init();var b=0;joms.jQuery(".cTabsBar li").each(function(){joms.jQuery(this).attr("id","cTab-"+b).children("a").click(function(){if(joms.jQuery(this).parent("li").hasClass("cTabDisabled")){joms.jQuery(this).blur();
