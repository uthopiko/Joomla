...
joms.gallery.createPhotoTag(c);joms.gallery.createPhotoTextTag(c);},addPhotoTag:function(c){var b=joms.jQuery("#cGallery .photoTags");var a=b.data("newPhotoTag");var text=joms.jQuery('.selected span').text();
if(c>0||c==-1){jax.call("community","photos,ajaxAddPhotoTag",a.photoId,c==-1?'NULL':c,a.top,a.left,a.width,a.height,text);}joms.gallery.cancelNewPhotoTag();},removePhotoTag:function(a){jax.call("community","photos,ajaxRemovePhotoTag",a.photoId,a.userId);
