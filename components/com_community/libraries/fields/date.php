...
class CFieldsDate extends CProfileField
{
	...
	public function getFieldHTML( $field , $required )
	{
		...
		$html .= '<input type="text" size="3" maxlength="2" name="field' . $field->id . '[]" value="' . $day . '" class="validate-custom-date '.  $class .'"'. $title.$style.$readonly.' /> ' . JText::_('COM_COMMUNITY_DAY_FORMAT');
		...
		$html .= '</select>&nbsp;/&nbsp;';
		$html .= '<input type="text" size="5" maxlength="4" name="field' . $field->id . '[]" value="' . $year . '" class="validate-custom-date' . $class . '"'.$title.$style.$readonly.' /> ' . JText::_('COM_COMMUNITY_YEAR_FORMAT');
