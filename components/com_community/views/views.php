...
class CommunityView extends JViewLegacy
{
	...
	public function __construct($config = array())
	{
		...
		$view = $jinput->request->get('view' , ''); //JRequest::getVar('view' , '' , 'REQUEST' );
	}
	...
	public function showSubmenu( )
	{
		...
		if (!empty($submenu))
		{
			$view   = $jinput->get->get('view' , '', 'STRING'); //JRequest::getVar('view' , '' , 'GET');
			$task   = $jinput->get->get('task' , '', 'STRING'); //JRequest::getVar('task' , '' , 'GET');
	...
	public function showHeader($title, $icon = null, $buttons = null)
	{
		...
		$view = $jinput->request->get('view', 'frontpage', 'STRING'); //JRequest::getVar('view', 'frontpage', 'REQUEST');
