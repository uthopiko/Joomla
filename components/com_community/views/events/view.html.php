...
class CommunityViewEvents extends CommunityView
{
	...
	public function display($tpl = null)
	{
		...
		$eventparent = $jinput->get->get('parent','','INT'); //JRequest::getVar('parent','', 'GET');
	...
	**/
	...
	public function _displayForm($event)
	{
		...
		$event->startdatetime	= $jinput->post->get('startdatetime', '00:01', 'NONE'); //JRequest::getVar('startdatetime', '00:01', 'POST');
		$event->enddatetime	= $jinput->post->get('enddatetime', '23:59', 'NONE'); //JRequest::getVar('enddatetime', '23:59', 'POST');
	...
	public function search()
	{
		...
		$unit		=   $jinput->get('unit' , $config->get('eventradiusmeasure'), 'NONE');  //JRequest::getVar( 'unit', '' );

		$category	= JTable::getInstance( 'EventCategory' , 'CTable' );
		$category->load( $catId );

		$advance		    =   array();
		$advance['startdate']	    =   $jinput->get('startdate' , '', 'NONE');  //JRequest::getVar( 'startdate', '' );
		$advance['enddate']	    =   $jinput->get( 'enddate', '' , 'NONE'); //JRequest::getVar( 'enddate', '' );
		$advance['radius']	    =   $jinput->get( 'radius', '' , 'NONE'); //JRequest::getVar( 'radius', '' );
		$advance['fromlocation']    =   $jinput->get( 'location', '' , 'NONE'); //JRequest::getVar( 'location', '' );
