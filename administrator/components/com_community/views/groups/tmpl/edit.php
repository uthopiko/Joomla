...
<table  width="100%" class="paramlist admintable" cellspacing="1">
	<tr>
		<td class="paramlist_key">
			<label for="name" class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_TITLE');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_TITLE_TIPS'); ?>">
	...
	<tr>
		<td class="paramlist_key">
			<label for="description" class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_DESCRIPTION');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_BODY_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label for="categoryid" class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_CATEGORY');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_CATEGORY_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_TYPE');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_APPROVAL_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_DISCUSS_ORDER');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_ORDERING_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_PHOTOS');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_PHOTO_PERMISSION_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label for="grouprecentphotos-admin" class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_RECENT_PHOTO');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_RECENT_PHOTOS_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label for="discussordering" class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_VIDEOS');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_VIDEOS_PERMISSION_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label for="grouprecentvideos-admin" class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_RECENT_VIDEO');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_RECENT_VIDEO_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label for="grouprecentevents-admin" class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUP_EVENTS');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_EVENT_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_NEW_MEMBER_NOTIFICATION');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_NEW_MEMBER_NOTIFICATION_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_JOIN_REQUEST_NOTIFICATION');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_JOIN_REQUEST_NOTIFICATION_TIPS');?>">
	...
	<tr>
		<td class="paramlist_key">
			<label class="title jomTips" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_WALL_NOTIFICATION');?>::<?php echo JText::_('COM_COMMUNITY_GROUPS_WALL_NOTIFICATION_TIPS');?>">
