...
class CommunityViewActivities extends JViewLegacy
{
	...
	public function display( $tpl = null )
	{
		...
		$currentUser		= $jinput->request->get('actor' , 0, 'NONE'); //JRequest::getVar( 'actor' , 0 , 'REQUEST' );
		$currentArchived	= $jinput->request->get('archived' , 0, 'NONE'); //JRequest::getVar( 'archived', 0 , 'REQUEST' );
		$currentApp			= $jinput->request->get('app' , 'none', 'NONE'); //JRequest::getVar( 'app' , 'none' , 'REQUEST' );
