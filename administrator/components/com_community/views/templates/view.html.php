...
class CommunityViewTemplates extends JViewLegacy
{
	...
	public function getTemplates()
	{
		...
		foreach( $folders as $folder )
		{
			...
			{
				$obj->info	= JApplicationHelper::parseXMLInstallFile(  $templatesPath .'/'. $folder .'/'. COMMUNITY_TEMPLATE_XML );
			}
			else
			{
				$obj->info	= false;
	...
	public function getTemplate( $element , $override )
	{
		...
		{
			$obj->info	= JApplicationHelper::parseXMLInstallFile(  $templatesPath .'/'. $element .'/'. COMMUNITY_TEMPLATE_XML );
		}
		else
		{
			$obj->info	= false;
